...
test("3. app icon + favicon ada", () =>
  ...
  sizeOf("public/brand/bc2026-favicon.png") > 1000);
...
test("10. metadata icon memakai brand baru", () =>
  layout.includes("/brand/bc2026-favicon.png") && layout.includes("/icon-512.png") && layout.includes("/icon-192.png"));
...
test("15. login memakai brand baru", () =>
  read("app/(auth)/login/page.tsx").includes("/brand/bc2026-icon.png"));
test("16. register memakai brand baru", () =>
  read("app/(auth)/register/page.tsx").includes("/brand/bc2026-icon.png"));
...
test("21. shared public components memakai brand baru", () =>
  read("components/public/PublicNavbar.tsx").includes("/brand/bc2026-icon.png") &&
  read("components/public/PageFooter.tsx").includes("/brand/bc2026-icon.png") &&
  read("components/public/PageNavbar.tsx").includes("/brand/bc2026-icon.png"));
