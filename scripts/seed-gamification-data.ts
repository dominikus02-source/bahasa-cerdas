...
const BADGES: BadgeSeed[] = [
  ...
  // Hanya kriteria yang BELUM ada di badge asli. Sembilan lencana lain punya
  // syarat identik dengan badge yang sudah ada (mis. 'Mulai Panas' = 'Rajin 3
  // Hari', keduanya STREAK 3) sehingga murid melihat badge kembar — duplikatnya
  // dihapus dan kepemilikannya dipindahkan ke badge asli.
