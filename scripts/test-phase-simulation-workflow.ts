...
async function main() {
  ...
  assertContains("app/(dashboard)/murid/layout.tsx", "<ShellNavList />", "MuridLayout renders ShellNavList (canonical nav)")
  assertContains("components/shell/nav-config.ts", 'href: "/murid/profile"', "nav-config links to /murid/profile")
  assertContains("components/shell/nav-config.ts", 'href: "/arena"', "nav-config links to /arena")
  assertContains("components/shell/nav-config.ts", 'href: "/murid/karya"', "nav-config links to /murid/karya")
  assertContains("components/shell/nav-config.ts", 'href: "/arena/chat"', "nav-config links to /arena/chat")
  assertContains("components/shell/nav-config.ts", 'href: "/murid/pengaturan"', "nav-config links to /murid/pengaturan")
