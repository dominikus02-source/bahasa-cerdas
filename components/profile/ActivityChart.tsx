    ...
    >
          ...
          <span
            className={`rounded-full px-2 py-0.5 ring-1 ${
              mode === "AKTIVITAS"
                ...
                : "bg-slate-900/5 dark:bg-slate-900/5 text-slate-700 dark:text-white/45 ring-slate-900/10 dark:ring-white/10"
            }`}
          >
            Aktivitas
          </span>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        <div className="rounded-xl bg-slate-900/[0.05] dark:bg-white/[0.05] ring-1 ring-slate-900/10 dark:ring-white/10 px-3.5 py-3">
          <p className="inline-flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider text-slate-700 dark:text-white/45">
      ...
      {days.length === 0 ? (
        <div className="mt-5 rounded-xl border border-dashed border-slate-900/10 dark:border-white/10 px-4 py-8 text-center">
          <BarChart3 size={22} className="mx-auto mb-2 text-slate-700 dark:text-white/25" />
          <p className="text-sm text-slate-700 dark:text-white/45">{labelToday} belum ada data kegiatan 30 hari.</p>
          <p className="mt-1 text-xs text-slate-700 dark:text-white/30">
        ...
        <div className="mt-5">
          ...
          <div className="mt-2 flex justify-between text-[9px] text-slate-700 dark:text-white/30">
          ...
          <p className="mt-1 text-right text-[10px] text-slate-700 dark:text-white/35">
