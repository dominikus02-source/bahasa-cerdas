        ...
        <div className="mt-4 space-y-3">
          {filtered.map((k) => {
            ...
            return (
              <div
                key={k.id}
                className="rounded-xl bg-white/[0.05] ring-1 ring-white/10 p-4 transition-colors hover:bg-white/[0.08]"
              >
                <div className="flex items-start justify-between gap-3">
                  <Link href={`${titleHref}/${k.id}`} className="flex-1 min-w-0">
                    ...
                    <h4 className="font-semibold text-white text-sm leading-snug">{k.title}</h4>
                  ...
                  {onDelete && (
                    <button
                      ...
                      className="text-white/25 hover:text-rose-400 p-1 transition-colors shrink-0"
                    >
                      <X size={14} />
                    </button>
                  )}
