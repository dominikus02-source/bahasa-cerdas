...
export function TrialStatusCard() {
  ...
  if (status.isTrial && status.plan === "GURU_PRO_TRIAL") {
    return (
      <div className="bc-guru-card rounded-2xl p-5 hover:shadow-lg transition-all">
        <div className="flex items-start gap-4">
          <div className="bc-guru-icon w-12 h-12 rounded-xl flex items-center justify-center shrink-0">
  ...
  if (status.plan === "GURU_PRO") {
    return (
      <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5 hover:shadow-lg transition-all dark:border-amber-900/50 dark:bg-amber-950/20">
        <div className="flex items-start gap-4">
