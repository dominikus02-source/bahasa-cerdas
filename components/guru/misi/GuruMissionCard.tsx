...
function Skeleton() {
  return (
    <div className="rounded-3xl bg-white border border-blue-100 dark:bg-[#0b1d34] dark:border-blue-950/70 p-5 sm:p-6 shadow-lg shadow-blue-100/40 animate-pulse">
...
export function GuruMissionCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-[#f5f9ff] p-5 sm:p-6 shadow-lg shadow-blue-100/40 ring-1 ring-blue-100 dark:bg-[#0b1d34] dark:ring-blue-950/70">
      <div className="pointer-events-none absolute -top-20 -right-20 w-56 h-56 rounded-full bg-blue-100/40" />
      <div className="pointer-events-none absolute -bottom-24 -left-10 w-64 h-64 rounded-full bg-blue-100/25" />

      <div className="relative">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-600 to-sky-500 flex items-center justify-center shadow-md shadow-blue-200">
            <Sparkles size={24} className="text-white" />
          </div>
          <div>
            <h2 className="text-lg sm:text-xl font-bold text-emerald-900 flex items-center gap-2">
              Misi Guru Cerdas
              <span className="hidden sm:inline-flex items-center gap-1 text-[10px] px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full font-semibold uppercase tracking-wide">
                Mingguan
              </span>
            </h2>
