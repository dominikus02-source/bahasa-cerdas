...
export const kataPlayLevels: KataPlayLevel[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        questions: [
          q('wordChoice', 'Ayam dimulai huruf?', 'A', ['A', 'I', 'B', 'C'], { imageText: '🐔' }),
          q('wordChoice', 'Ikan dimulai huruf?', 'I', ['I', 'A', 'U', 'E'], { imageText: '🐟' }),
          q('wordChoice', 'Bola dimulai huruf?', 'B', ['B', 'D', 'P', 'M'], { imageText: '⚽' }),
          q('matching', 'Cocokkan!', 'ULAR', ['ULAR', 'AYAM', 'IKAN', 'ELANG'], { matchLeft: 'U', matchRight: 'ULAR', imageText: '🐍' }),
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          q('wordChoice', 'Pilih suku kata!', 'BI', ['BI', 'BU', 'BA', 'BE'], { imageText: 'BI' }),
      ...
      },
      {
        ...
        questions: [
          ...
          q('wordChoice', 'Pilih suku kata!', 'PA', ['PA', 'MA', 'BA', 'SA'], { imageText: 'PA' }),
      ...
      },
      {
        ...
        questions: [
          ...
          q('matching', 'Cocokkan!', 'BATU', ['BATU', 'BUKU', 'SAPI', 'PITA'], { matchLeft: 'BA', matchRight: 'BATU', imageText: '🪨' }),
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          q('wordChoice', 'Pilih kata yang benar!', 'BUKU', ['BUKU', 'BUKA', 'BAKU', 'BIKU'], { imageText: '📖' }),
          q('imageChoice', 'Apa ini?', 'KURSI', ['KURSI', 'MEJA', 'TAS', 'LAMPU'], { imageText: '🪑', hint: 'Untuk duduk' }),
      ...
      },
      {
        ...
        character: 'hazel', xpReward: 30,
        questions: [
          q('imageChoice', 'Hewan apa ini?', 'KUCING', ['KUCING', 'ANJING', 'AYAM', 'IKAN'], { imageText: '🐱' }),
          q('imageChoice', 'Hewan apa ini?', 'AYAM', ['AYAM', 'BEBEK', 'BURUNG', 'SAPI'], { imageText: '🐔' }),
          q('wordChoice', 'Pilih nama hewan!', 'SAPI', ['SAPI', 'SARI', 'SAPU', 'SABI'], { imageText: '🐄' }),
          q('trueFalse', 'Kucing suka makan ikan?', 'Benar', ['Benar', 'Salah']),
          q('matching', 'Cocokkan!', 'BURUNG', ['BURUNG', 'AYAM', 'IKAN', 'KUCING'], { matchLeft: '🐦', matchRight: 'BURUNG' }),
        ],
      },
      {
        ...
        character: 'zelby', xpReward: 30,
        questions: [
          q('imageChoice', 'Buah apa ini?', 'APEL', ['APEL', 'PISANG', 'MANGGA', 'JERUK'], { imageText: '🍎' }),
          q('imageChoice', 'Buah apa ini?', 'PISANG', ['PISANG', 'APEL', 'JERUK', 'MELON'], { imageText: '🍌' }),
          q('wordChoice', 'Benda di sekolah!', 'PENSIL', ['PENSIL', 'PESIL', 'PENSAL', 'PENSEL'], { imageText: '✏️' }),
    ...
    lessons: [
      {
        ...
        character: 'zelby', xpReward: 30,
        questions: [
          q('imageChoice', 'Kegiatan apa?', 'MAKAN', ['MAKAN', 'MINUM', 'TIDUR', 'MANDI'], { imageText: '🍽️' }),
          q('imageChoice', 'Kegiatan apa?', 'TIDUR', ['TIDUR', 'DUDUK', 'BERDIRI', 'LARI'], { imageText: '😴' }),
          q('wordChoice', 'Pilih kata kerja!', 'MANDI', ['MANDI', 'MANIS', 'MANDU', 'MANDA'], { imageText: '🚿' }),
      ...
      },
      {
        ...
        character: 'hazel', xpReward: 30,
        questions: [
          q('imageChoice', 'Kegiatan apa?', 'MEMBACA', ['MEMBACA', 'MENULIS', 'MENGGAMBAR', 'MENYANYI'], { imageText: '📖' }),
          q('imageChoice', 'Kegiatan apa?', 'MENULIS', ['MENULIS', 'MEMBACA', 'MELUKIS', 'MENARI'], { imageText: '✍️' }),
          q('wordChoice', 'Pilih kata kerja!', 'BELAJAR', ['BELAJAR', 'BELAJAK', 'BELAGAR', 'BELANJA'], { imageText: '📚' }),
      ...
      },
      {
        ...
        questions: [
          q('imageChoice', 'Apa yang dilakukan?', 'BERLARI', ['BERLARI', 'BERJALAN', 'MELOMPAT', 'BERDIRI'], { imageText: '🏃' }),
          q('imageChoice', 'Apa yang dilakukan?', 'BERMAIN', ['BERMAIN', 'BEKERJA', 'BELAJAR', 'BERLARI'], { imageText: '🎮' }),
          q('wordChoice', 'Pilih kata kerja!', 'MELOMPAT', ['MELOMPAT', 'MELOMPAK', 'MELOMPIT', 'MELOMPOT'], { imageText: '🦘' }),
          q('matching', 'Cocokkan!', 'BERMAIN', ['BERMAIN', 'BERLARI', 'BELAJAR', 'BEKERJA'], { matchLeft: '🎈', matchRight: 'BERMAIN' }),
        ],
      },
    ],
  },
