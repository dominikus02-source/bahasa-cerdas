    ...
    <div className="mb-3 flex w-full items-center justify-between">
      <div className="flex items-center gap-2">
        <Link
          ...
          className={`${btn} h-12 w-12 shrink-0 bg-white border-2 border-slate-200 text-[#161B3A] dark:text-[#F1EDFF] hover:bg-slate-50`}
        >
          <ArrowLeft className="h-5 w-5 text-[#161B3A] dark:text-[#F1EDFF] text-[#161B3A] dark:text-[#F1EDFF]" />
        </Link>
      ...
      <button
        ...
        className={`${btn} h-11 w-11 bg-white border-2 border-slate-200 text-[#161B3A] dark:text-[#F1EDFF] hover:bg-slate-50`}
      >
