      ...
      <div className="relative max-w-xl mx-auto px-4 py-5 min-h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className={`${btn} w-11 h-11 bg-pink-500/20 border-2 border-pink-400/30 hover:bg-pink-500/30`}
        ...
        {screen === "levels" && (
          <div className={`ik-screen bg-white dark:bg-gradient-to-br dark:from-[#221420] dark:to-[#2C1E2A] rounded-3xl ${chunky} p-5`}>
            <div className="flex items-center justify-between mb-4">
            <button className={`${btn} w-12 h-12 bg-pink-500/30 border-2 border-pink-400/40 hover:bg-pink-500/40`} onClick={() => setScreen("start")} aria-label="Kembali">
              <X className="w-5 h-5 text-[#161B3A] dark:text-pink-100" />
            </button>
        ...
        {screen === "game" && (
          <div className="ik-screen flex flex-col items-center">
            ...
            <div className="w-full max-w-[480px] flex items-center justify-between mt-3">
              ...
              <button className={`${btn} w-11 h-11 bg-pink-500/20 border-2 border-pink-400/30 hover:bg-pink-500/30`} onClick={togglePause} aria-label={paused ? "Lanjut" : "Jeda"}>
