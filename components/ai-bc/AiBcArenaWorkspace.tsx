            ...
            <div className="grid w-full grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
              {ARENA_AI_SUGGESTED_PROMPTS.map((prompt) => (
                <button
                  ...
                  className="rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-left text-xs text-slate-600 shadow-sm transition-all hover:border-violet-300 hover:bg-violet-50 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-300 dark:hover:border-violet-800 dark:hover:bg-violet-950/40"
                >
                  {prompt}
                </button>
              ))}
