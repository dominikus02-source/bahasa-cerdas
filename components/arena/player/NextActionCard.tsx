...
export default function NextActionCard({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-white/5 dark:bg-slate-900/5" />
      <div className="pointer-events-none absolute -bottom-6 -left-6 h-24 w-24 rounded-full bg-white/5 dark:bg-slate-900/5" />
