  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <span className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-white px-4 py-2 text-sm font-bold text-violet-700 shadow-md transition-all group-hover:gap-2.5">
          {nextAction.ctaLabel}
          <ArrowRight size={16} />
        </span>
      </div>
