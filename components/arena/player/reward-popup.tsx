    ...
    <div className="pointer-events-none fixed left-1/2 top-16 z-[90] flex w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 flex-col gap-2">
      <AnimatePresence>
        {current && (
          ...
          >
            <div className={`flex items-center gap-3 rounded-2xl border px-4 py-3 backdrop-blur-md ${TYPE_META[current.type]?.tint ?? "bg-white/10 dark:bg-slate-900/10"} bg-[#0e1735]/85`}>
              ...
              <button
                className="pointer-events-auto rounded-full bg-white/10 dark:bg-slate-900/10 px-2 py-0.5 text-[10px] font-bold text-[var(--px-text-dim)] hover:text-white"
