...
export default async function ArenaGimPage() {
      ...
      <div className="relative z-10 px-5 pb-6">
        ...
        >
          ...
          <div className="relative z-10 p-[18px] flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-white/15 dark:bg-slate-900/15 backdrop-blur flex items-center justify-center shrink-0 border border-white/20 group-hover:scale-110 transition-transform">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-2">
                <span className="text-[10px] font-bold bg-white/20 dark:bg-slate-900/20 px-2 py-0.5 rounded-md text-white">
                  &#x1F3AE; Gerakan jari
                </span>
 ...
 <div className="shrink-0 w-9 h-9 rounded-full bg-white/15 dark:bg-slate-900/15 flex items-center justify-center text-white group-hover:bg-white/25 transition-colors">
              &rarr;
            </div>
          </div>
        </Link>
        ...
        >
          ...
          <div className="relative z-10 p-[18px] flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-white/15 dark:bg-slate-900/15 backdrop-blur flex items-center justify-center shrink-0 border border-white/20 group-hover:scale-105 transition-transform">
              <Users size={30} className="text-white" />
            </div>
            <div className="flex-1 min-w-0">
              <div className="inline-flex items-center gap-1 bg-white/20 dark:bg-slate-900/20 backdrop-blur px-2 py-0.5 rounded-full text-[10px] font-extrabold text-white tracking-wider mb-1.5">
