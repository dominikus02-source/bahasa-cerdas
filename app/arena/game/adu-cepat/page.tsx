            ...
            <div className="text-center max-w-sm animate-fade-in">
              ...
              <div className="space-y-3">
                ...
                <Link
                  ...
                  className="block w-full py-3.5 rounded-2xl bg-white/10 border border-white/20 text-white/80 font-semibold text-sm text-center hover:bg-white/20 transition-all"
                >
                  Buat Ruangan Manual
                </Link>
              </div>
          ...
          {phase === "searching" && (
            <div className="text-center animate-fade-in">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-xl bg-white/10 border border-white/20 text-white/70 text-sm font-medium hover:bg-white/20 transition-all"
              >
                Batalkan
              </button>
            </div>
          ...
          {phase === "result" && (
            <div className="text-center animate-fade-in w-full max-w-sm">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleBack}
                  className="flex-1 py-3.5 rounded-2xl bg-white/10 border border-white/20 text-white/80 font-semibold text-sm text-center hover:bg-white/20 transition-all"
                >
                  Ke Menu Gim
                </button>
              </div>
