  ...
  return (
    <div className="arena-page px-4 py-6 md:px-6">
      ...
      <div className="grid gap-4">
        {/* UKBI */}
        <Link href="/arena/simulasi/ukbi" className="block bg-white dark:bg-slate-800/90 rounded-2xl border border-gray-100 dark:border-slate-800 p-5 hover:shadow-md hover:border-violet-200 transition-all group">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-gray-900 dark:text-slate-100">Simulasi UKBI</h2>
                <ChevronRight size={18} className="text-gray-300 group-hover:text-violet-500 dark:text-violet-400 transition-colors" />
              </div>
        ...
        {/* TKA */}
        <Link href="/arena/simulasi/tka" className="block bg-white dark:bg-slate-800/90 rounded-2xl border border-gray-100 dark:border-slate-800 p-5 hover:shadow-md hover:border-violet-200 transition-all group">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-gray-900 dark:text-slate-100">Simulasi TKA</h2>
                <ChevronRight size={18} className="text-gray-300 group-hover:text-violet-500 dark:text-violet-400 transition-colors" />
              </div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mt-1">
        ...
        {/* Hasil */}
        <Link href="/arena/simulasi/hasil" className="block bg-white dark:bg-slate-800/90 rounded-2xl border border-gray-100 dark:border-slate-800 p-5 hover:shadow-md hover:border-violet-200 transition-all group">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <h2 className="font-bold text-gray-900 dark:text-slate-100">Hasil & Dokumen Latihan</h2>
                <ChevronRight size={18} className="text-gray-300 group-hover:text-violet-500 dark:text-violet-400 transition-colors" />
              </div>
              <p className="text-xs text-gray-500 dark:text-slate-400 mt-1">
