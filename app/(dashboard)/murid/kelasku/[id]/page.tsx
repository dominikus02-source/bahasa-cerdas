    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/murid/gabung-kelas" className="mt-4 text-violet-600 hover:underline block">Kembali</Link>
        </div>
      </div>
    );
  }
          ...
          {ketua ? (
            ...
            <div className="mt-4">
              <button
                onClick={handleClaim}
                disabled={claiming}
                className="flex items-center gap-2 text-sm bg-white/15 hover:bg-white/25 text-white px-4 py-2 rounded-xl transition-colors disabled:opacity-50"
              >
