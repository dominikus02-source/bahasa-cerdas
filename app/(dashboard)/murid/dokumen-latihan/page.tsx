...
export default function MuridDokumenLatihanPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Dokumen Hasil Latihan</h1>
        <p className="text-sm text-gray-500 mt-1">Lihat hasil simulasi UKBI/TKA dan dokumen yang diperoleh.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-500 font-medium">Belum ada dokumen hasil latihan</p>
          <p className="text-sm text-gray-400 mt-1">Selesaikan latihan UKBI/TKA untuk mendapatkan dokumen hasil</p>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-gray-400 font-medium">Dokumen Hasil</p>
