      ...
      <aside className="w-64 h-screen bg-white/80 backdrop-blur-xl border-r border-gray-100/50 flex flex-col fixed left-0 top-0 shadow-xl shadow-gray-100/50">
        ...
        {user.isFounder && (
          <div className="px-3 mb-2">
            ...
            <Link href="/guru/beranda" className="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm mb-1 transition-all duration-200 text-gray-600 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-green-50 hover:text-emerald-700">
              ...
              <span className="font-medium group-hover:text-emerald-700">Dashboard Guru</span>
            </Link>
            <Link href="/admin" className="group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm mb-1 transition-all duration-200 text-gray-600 hover:bg-gradient-to-r hover:from-red-50 hover:to-orange-50 hover:text-red-700">
              ...
              <span className="font-medium group-hover:text-red-700">Admin Panel</span>
            </Link>
          </div>
        )}
