...
const GAMES = [
  ...
  },
  {
    ...
    subtitle: "Isi Kotak, Asah Kosakata",
    desc: "Isi kotak teka-teki dengan kata yang tepat! 12 level bertema, soal baru tiap main, dan sistem nyawa yang bikin ketagihan.",
    Icon: PuzzleIcon,
