  ...
  return (
    <div className="arena-page">
      ...
      <section className="relative mb-6 overflow-hidden rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 px-5 py-8 text-white shadow-lg shadow-violet-500/20 md:px-8 md:py-12">
        ...
        <div className="pointer-events-none absolute right-8 top-6 h-10 w-10 rotate-12 rounded-xl bg-white/10" aria-hidden />
        <div className="relative">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-extrabold text-violet-700 shadow-sm transition-all hover:bg-violet-50"
            >
              <PenLine size={15} /> Buat Karya
            </Link>
            <a
              href="#karya-saya"
              className="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/15 px-5 py-2.5 text-sm font-bold text-white transition-all hover:bg-white/25"
            >
              Karya Saya
            </a>
          </div>
