          ...
          {GRADES.map(grade => {
            ...
            return (
              <Card key={grade} className="border border-slate-100 overflow-hidden">
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-sky-500 flex items-center justify-center text-white font-bold text-sm shrink-0">
                    {grade}
                  </div>
                    <div className="flex-1">
                            ...
                            <div className="px-4 pb-3 space-y-1">
                              {units.length === 0 ? (
                                ...
                                units.map(unit => (
                                    ...
                                    >
                                      <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-blue-100 to-sky-100 flex items-center justify-center text-blue-700 font-bold text-xs shrink-0">
                                        {unit.order}
                                      </div>
