                                    ...
                                    >
                                      ...
                                      <div className="flex items-center gap-1 shrink-0">
                                        ...
                                        <Button
                                          size="sm"
                                          variant="outline"
                                          className="text-blue-700 border-emerald-200 hover:bg-blue-50"
      ...
      {assignUnit && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => !assignLoading && setAssignUnit(null)}>
          <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-xl" onClick={e => e.stopPropagation()}>
            ...
            {assignSuccess ? (
              <div className="flex flex-col items-center gap-3 py-8 text-blue-700">
                  ...
                  {JENIS_OPTIONS.map(opt => (
                    <button
                      ...
                      className={`text-left px-3 py-2.5 rounded-lg border transition-colors ${
                        jenis === opt.value ? "border-emerald-300 bg-blue-50" : "border-slate-100 hover:border-slate-200"
                      }`}
                    >
                    ...
                    groups.map(g => (
                      ...
                      >
                        <input
                          ...
                          className="rounded text-blue-700 focus:ring-emerald-500"
                        />
                        <div className="flex-1 min-w-0">
