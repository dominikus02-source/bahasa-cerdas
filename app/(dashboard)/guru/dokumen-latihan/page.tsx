...
export default function GuruDokumenLatihanPage() {
  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Repository Pembelajaran</h1>
      ...
      {/* Link ke AI Review Center & Pusat Evaluasi */}
      <div className="grid sm:grid-cols-2 gap-3 mt-6">
        <Link href="/guru/tinjau-simulasi" className="rounded-2xl border border-violet-100 bg-violet-50/50 p-4 flex items-center gap-3 hover:border-violet-300 transition-colors">
        ...
        <Link href="/guru/hasil-simulasi" className="rounded-2xl border border-emerald-100 bg-emerald-50/50 p-4 flex items-center gap-3 hover:border-emerald-300 transition-colors">
