      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-bold text-slate-800">Kelas & Multiplayer</h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            {/* Ruang Aktif */}
            <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl transition-all">
              <div className="h-20 bg-gradient-to-br from-blue-500 via-cyan-600 to-indigo-700 relative overflow-hidden flex items-center justify-center">
        ...
        {/* Riwayat Gim Siswa — tampil lewat tombol, tidak langsung */}
        <div className="mb-10">
          <button
            type="button"
