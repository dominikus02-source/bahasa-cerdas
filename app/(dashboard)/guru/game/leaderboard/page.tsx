        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 py-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-200 text-sm">Papan peringkat guru — dihitung dari XP Guru (bukan XP murid)</p>
            </div>
          </div>
        </div>
      </div>
                        ...
                        <tr key={e.userId} className={`border-b border-slate-50 hover:bg-slate-50 transition-colors ${podium ? "bg-amber-50/50" : ""}`}>
                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-2">
                              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-600 to-sky-500 flex items-center justify-center text-white text-[10px] font-bold">
