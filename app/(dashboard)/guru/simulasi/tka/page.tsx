  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bc-guru-stat-card rounded-xl p-4">
      ...
      <div className="grid gap-4 md:grid-cols-2 mb-6">
        {tracks.map(track => (
          <div key={track.id} className={`bc-guru-surface-interactive rounded-xl p-5 ${track.available ? "" : "opacity-60"}`}>
            ...
            <div className="flex items-center gap-3 mt-2">
              {track.available && track.paketId && (
                <Link
                  ...
                  className="inline-flex items-center gap-1 rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-bold text-blue-700 transition-colors hover:bg-blue-100 dark:bg-blue-950/40 dark:text-blue-300 dark:hover:bg-blue-950/60"
                >
      ...
      <div className="flex gap-3">
        <Link
          href="/guru/hasil-simulasi"
          className="bc-guru-primary flex items-center gap-2 rounded-xl px-5 py-2.5 font-medium transition-colors"
        >
          <TrendingUp size={16} /> Lihat Hasil Murid
        </Link>
        <Link
          href="/guru/bank-soal"
          className="bc-guru-surface-interactive flex items-center gap-2 rounded-xl px-5 py-2.5 font-medium text-slate-700 dark:text-slate-200"
        >
