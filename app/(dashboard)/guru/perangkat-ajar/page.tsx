...
const LEVEL_ICONS: Record<string, React.ReactNode> = {
  SD: <BookMarked size={20} className="text-blue-700 dark:text-blue-300" />,
  SMP: <BookOpen size={20} className="text-blue-700 dark:text-blue-300" />,
  SMA: <GraduationCap size={20} className="text-blue-700 dark:text-blue-300" />,
};
  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto py-12 px-4">
        <div className="bg-blue-50 border border-blue-200 dark:bg-blue-950/30 dark:border-blue-900/60 rounded-xl p-8 text-center">
          <Folder className="w-12 h-12 text-blue-300 mx-auto mb-3" />
          <h2 className="text-lg font-semibold text-blue-800 dark:text-blue-200">Belum ada data</h2>
    ...
    return (
      <div className="max-w-5xl mx-auto py-6 px-4">
        <button
          ...
          className="flex items-center gap-2 text-sm text-slate-500 hover:text-blue-700 dark:text-blue-300 mb-4 transition-colors"
        >
        ...
        <div className="flex items-center gap-3 mb-6">
          <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-950/50 flex items-center justify-center text-xl">
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400 dark:focus:ring-blue-900 transition"
          />
        </div>
          ...
          {filteredFiles.map((f) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-3 px-4 py-3 bg-white border border-slate-100 rounded-xl hover:border-blue-300 hover:shadow-sm transition group"
              >
                ...
                <div className="flex items-center gap-1.5 shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                  <a
                    ...
                    className="p-2 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/40 text-slate-400 hover:text-blue-700 dark:text-blue-300 transition"
                    title="Buka di Drive"
                  >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-medium transition ${
                levelTab === lv
                  ...
                  : "bg-white border border-blue-100 text-slate-600 hover:bg-blue-50 hover:border-blue-200 dark:bg-[#0b1d34] dark:border-blue-950/70 dark:text-slate-300 dark:hover:bg-blue-950/35"
              }`}
            >
              {LEVEL_ICONS[lv]} {lv}
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {filteredGrades.map((g) => (
          <button
            ...
            className="text-left bg-white border border-slate-100 rounded-xl p-4 hover:border-blue-300 hover:shadow-md transition group"
          >
