  ...
  if (selectedGrade) {
    return (
      <div className="max-w-5xl mx-auto py-6 px-4">
        ...
        <div className="guru-role-card flex items-center gap-3 mb-6 rounded-[22px] border border-blue-100 bg-white p-5 shadow-sm dark:border-blue-950/70 dark:bg-[#0b1d34]">
        ...
        <div className="relative mb-5">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition"
          />
        </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {filteredGrades.map((g) => (
          <button
            ...
            className="text-left bg-white border border-slate-100 rounded-xl p-4 hover:border-blue-200 hover:shadow-md transition group"
          >
