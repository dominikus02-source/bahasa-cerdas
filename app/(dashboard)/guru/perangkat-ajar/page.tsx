  ...
  if (error) {
    return (
      <div className="max-w-4xl mx-auto py-12 px-4">
        <div className="bc-guru-surface rounded-xl border border-blue-200 p-8 text-center">
          ...
          {filteredFiles.map((f) => {
            ...
            return (
              <div
                ...
                className="bc-guru-surface-interactive group flex items-center gap-3 rounded-xl px-4 py-3"
              >
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {filteredGrades.map((g) => (
          <button
            ...
            className="bc-guru-surface-interactive group rounded-xl p-4 text-left"
          >
