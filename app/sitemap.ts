...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/fitur`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${SITE_URL}/kebijakan-privasi`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.4 },
    { url: `${SITE_URL}/syarat-ketentuan`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.4 },
