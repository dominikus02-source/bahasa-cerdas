// k6 load test — UKBI Simulation (300 concurrent users, 9 min)
// Ramp-up: 0 → 300 over 2 min, stay 5 min, ramp-down: 300 → 0 over 2 min
//
// Usage:
...
export const options = {
  stages: [
    { duration: "2m", target: 300 },   // Ramp up 0 → 300
