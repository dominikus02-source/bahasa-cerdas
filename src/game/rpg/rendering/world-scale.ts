 ...
 *
 * - LOGICAL_TILE_PX: 64×64 per tile at zoom 1 (world-authoritative unit).
 * - ART_SCALE: 2× (tiles ship at 128×128; hero canvas 224×224 = 112 logical).
 * - FRAME_MS: 80ms rhythm (12-fps feel).
 * - ZOOM: fixed logical zoom, range 0.8 (desktop wide) – 1.25 (mobile).
 */

export const LOGICAL_TILE_PX = 64;
export const ART_SCALE = 2;
export const ART_TILE_PX = LOGICAL_TILE_PX * ART_SCALE;
export const HERO_CANVAS_PX = 224;
