...
const BINDINGS: Record<VisualMapId, Record<number, string[]>> = {
  "map.desa": {
    ...
    [RPG_TILES.ST]: ["desa_stairs_stone", "desa_stairs_wood"],
  ...
  "map.gunung": {
    ...
    [RPG_TILES.ST]: ["gunung_rock_path_01", "gunung_rock_path_02", "gunung_rock_path_03", "gunung_rock_path_04"],
  ...
  "map.menara": {
    ...
    [RPG_TILES.SR]: ["menara_platform_edge"],
    [RPG_TILES.GP]: ["menara_cloud_bridge"],
  },
};
